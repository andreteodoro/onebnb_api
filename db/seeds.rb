...
# Properties
property = Property.new price: 20, address: a1, facility: f1, user: u1, status: :active, name: "#{a1.city} #{a1.id}", rating: 1, accommodation_type: :whole_house, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
[p1, p21, p22, p23].each {|photo| property.photos << photo}
[c1, c2, c3, c4, c5, c6].each {|comment| property.comments << comment}
property.save!
property = Property.new price: 20, address: a2, facility: f1, user: u1, status: :active, name: "#{a2.city} #{a2.id}", rating: 4, accommodation_type: :whole_house, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
[p2, p24, p25, p26].each {|photo| property.photos << photo}
property.save!
property = Property.new price: 20, address: a3, facility: f1, user: u1, status: :active, name: "#{a3.city} #{a3.id}", rating: 1, accommodation_type: :whole_house, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
property.photos << p3
property.save!
property = Property.new price: 20, address: a4, facility: f1, user: u1, status: :active, name: "#{a4.city} #{a4.id}", rating: 4, accommodation_type: :whole_house, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
property.photos << p4
property.save!
property = Property.new price: 20, address: a5, facility: f1, user: u1, status: :active, name: "#{a5.city} #{a5.id}", rating: 1, accommodation_type: :whole_house, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
property.photos << p5
property.save!
property = Property.new price: 20, address: a6, facility: f1, user: u1, status: :active, name: "#{a6.city} #{a6.id}", rating: 4, accommodation_type: :whole_bedroom, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
property.photos << p6
property.save!
property = Property.new price: 20, address: a7, facility: f1, user: u1, status: :active, name: "#{a7.city} #{a7.id}", rating: 1, accommodation_type: :whole_bedroom, beds: 2, bedroom: 3, bathroom: 2, guest_max: 5, description: 'É um belo Lugar para se visita', priority: false
property.photos << p7
property.save!
property = Property.new price: 20, address: a8, facility: f1, user: u1, status: :active, name: "#{a8.city} #{a8.id}", rating: 0, accommodation_type: :whole_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p8
property.save!
property = Property.new price: 20, address: a9, facility: f1, user: u1, status: :active, name: "#{a9.city} #{a9.id}", rating: 5, accommodation_type: :whole_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p9
property.save!
property = Property.new price: 20, address: a10, facility: f1, user: u1, status: :active, name: "#{a10.city} #{a10.id}", rating: 0, accommodation_type: :whole_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p10
property.save!

property = Property.new price: 20, address: a11, facility: f2, user: u2, status: :active, name: "#{a11.city} #{a11.id}", rating: 5, accommodation_type: :whole_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p11
property.save!
...
property.photos << p12
property.save!
property = Property.new price: 20, address: a13, facility: f2, user: u2, status: :active, name: "#{a13.city} #{a13.id}", rating: 5, accommodation_type: :shared_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p13
property.save!
property = Property.new price: 20, address: a14, facility: f2, user: u2, status: :active, name: "#{a14.city} #{a14.id}", rating: 2, accommodation_type: :shared_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p14
property.save!
property = Property.new price: 20, address: a15, facility: f2, user: u2, status: :active, name: "#{a15.city} #{a15.id}", rating: 2, accommodation_type: :shared_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p15
property.save!
property = Property.new price: 20, address: a16, facility: f2, user: u2, status: :active, name: "#{a16.city} #{a16.id}", rating: 2, accommodation_type: :shared_bedroom, beds: 3, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p16
property.save!
property = Property.new price: 20, address: a17, facility: f2, user: u2, status: :active, name: "#{a17.city} #{a17.id}", rating: 4, accommodation_type: :shared_bedroom, beds: 4, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p17
property.save!
property = Property.new price: 20, address: a18, facility: f2, user: u2, status: :active, name: "#{a18.city} #{a18.id}", rating: 1, accommodation_type: :shared_bedroom, beds: 4, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p18
property.save!
property = Property.new price: 20, address: a19, facility: f2, user: u2, status: :active, name: "#{a19.city} #{a19.id}", rating: 1, accommodation_type: :shared_bedroom, beds: 4, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p19
property.save!
property = Property.new price: 20, address: a20, facility: f2, user: u2, status: :active, name: "#{a20.city} #{a20.id}", rating: 1, accommodation_type: :shared_bedroom, beds: 4, bedroom: 4, bathroom: 3, guest_max: 4, description: 'É um belo Lugar para se visita', priority: false
property.photos << p20
property.save!
